...
> 📌 Bản đề xuất v1 (do ClaudeCode soạn theo yêu cầu của Viện Chủ ngày 2026-07-10). Các con số đánh dấu *(đề xuất)* cần Viện Chủ xác nhận trước khi implement.

## 1. Vai trò của Chân Khí
Chân Khí là tài nguyên điều tiết **THỜI LƯỢNG chơi/học mỗi phiên** — công cụ để phụ huynh điều phối thời gian sử dụng app của con. Chân Khí **không phải hình phạt học lực**: nó không liên quan đúng/sai, chỉ liên quan "đã chơi bao nhiêu".

Nguyên tắc xương sống: **mọi hoạt động SINH ĐIỂM đều tiêu hao Chân Khí; hoạt động không sinh điểm thì miễn phí.** (Con chơi được điểm thì ngược lại năng lượng giảm — đúng chỉ đạo của Viện Chủ.)

## 2. Cấu hình bởi Phụ huynh (per từng con, tại Ngân Các / ParentConsole)
...
| `resetHours` | 3 | **2 / 3 / 5** | Số giờ để hồi ĐẦY lại sau khi cạn về 0 — do phụ huynh chọn 1 trong 3 mốc. |
...
*   **Phương án A — Reset trọn gói (khuyến nghị, bám sát lời Viện Chủ):** Thời điểm Chân Khí chạm 0, hệ thống ghi `depletedAt` và hẹn giờ `resetHours`. Hết giờ → hồi **ĐẦY** về `maxEnergy` một lần. Ưu điểm: trẻ dễ hiểu ("nghỉ 3 tiếng rồi quay lại"), phụ huynh dễ hình dung lịch phiên chơi (VD: max 100 + reset 3h ≈ tối đa ~3-4 phiên/ngày).
...
*   **Phụ huynh ban thưởng thủ công:** nút "Ban Chân Khí" trong ParentConsole — hồi đầy tức thì khi phụ huynh muốn cho con học thêm ngay (VD: con xin học thêm buổi tối).
...
*   Báo cáo cho phụ huynh: "con cạn năng lượng X lần/tuần, thường vào khung giờ nào" — giúp phụ huynh cân chỉnh `maxEnergy` / `resetHours` cho hợp nhịp sinh hoạt.

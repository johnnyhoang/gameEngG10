...
## 2. Cấu hình bởi Chủ nhiệm (per từng con, tại Phòng Tài Vụ / TutorConsole)
...
| Mini-game Công Viên Thư Giãn (mỗi ván) | -10 *(đề xuất)* |
...
*   **Chủ nhiệm ban thưởng thủ công:** nút "Ban Năng Lượng" trong TutorConsole — hồi đầy tức thì khi chủ nhiệm muốn cho con học thêm ngay (VD: con xin học thêm buổi tối).

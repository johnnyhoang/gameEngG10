...
VALUES
  ...
  (
    ...
    'core-theory', 
    '["Sử dụng tham số Denavit-Hartenberg (DH) để lập ma trận biến đổi thuần nhất A_i từ khớp i-1 sang khớp i.", "Viết code lắng nghe transform (TF listener) trong ROS 2 để chuyển tọa độ vật cản từ hệ tọa độ laser_link về base_link."]'::jsonb, 
...
VALUES
  ('act-lesson-cs_rob_01', 'robot-software-architecture', 'lesson', 'Hệ điều hành Robot (ROS 2 Fundamentals)', '{"lesson_id": "cs_rob_01"}'::jsonb, 10, 10, 20, 'cs_robot_programming', 13),
  ('act-lesson-cs_rob_02', 'robot-kinematics', 'lesson', 'Động học Robot & Quản lý Hệ tọa độ (TF2)', '{"lesson_id": "cs_rob_02"}'::jsonb, 10, 10, 20, 'cs_robot_programming', 13),
  ('act-lesson-cs_rob_03', 'robot-kinematics', 'lesson', 'Lập trình Điều khiển Động cơ & Thuật toán PID', '{"lesson_id": "cs_rob_03"}'::jsonb, 20, 10, 20, 'cs_robot_programming', 13),
  ('act-lesson-cs_rob_04', 'robot-perception', 'lesson', 'Tích hợp Cảm biến & Đọc dữ liệu (Sensor Integration)', '{"lesson_id": "cs_rob_04"}'::jsonb, 10, 10, 20, 'cs_robot_programming', 13),
  ('act-lesson-cs_rob_05', 'robot-perception', 'lesson', 'Bản đồ hóa SLAM & Định vị AMCL', '{"lesson_id": "cs_rob_05"}'::jsonb, 20, 10, 20, 'cs_robot_programming', 13),
  ('act-lesson-cs_rob_06', 'robot-navigation', 'lesson', 'Lập kế hoạch đường đi & Điều hướng (Nav2)', '{"lesson_id": "cs_rob_06"}'::jsonb, 10, 10, 20, 'cs_robot_programming', 13),
  ('act-lesson-cs_rob_07', 'robot-navigation', 'lesson', 'Bản đồ chi phí Costmap & Thiết lập Vùng an toàn', '{"lesson_id": "cs_rob_07"}'::jsonb, 20, 10, 20, 'cs_robot_programming', 13),
  ('act-lesson-cs_rob_08', 'robot-perception', 'lesson', 'Thị giác máy tính OpenCV trong Robotics', '{"lesson_id": "cs_rob_08"}'::jsonb, 30, 10, 20, 'cs_robot_programming', 13),
  ('act-lesson-cs_rob_09', 'robot-software-architecture', 'lesson', 'Lập trình Máy trạng thái & Cây hành vi (Behavior Trees)', '{"lesson_id": "cs_rob_09"}'::jsonb, 20, 10, 20, 'cs_robot_programming', 13),
  ('act-lesson-cs_rob_10', 'robot-software-architecture', 'lesson', 'Mô phỏng Robot vật lý 3D với Gazebo & URDF', '{"lesson_id": "cs_rob_10"}'::jsonb, 30, 10, 20, 'cs_robot_programming', 13)
ON CONFLICT (id) DO UPDATE SET

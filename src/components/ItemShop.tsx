    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div>
        <h3 className={`font-orbitron font-bold text-sm uppercase tracking-wider mb-4 flex items-center gap-2 ${isUnicorn ? 'text-violet-700' : 'text-synth-cyan'}`}>
          <Shield className="w-4 h-4" /> Đơn Dược & Pháp Khí
        </h3>
          ...
          <div className={`glass-panel rounded-2xl p-5 flex justify-between items-center ${
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="space-y-1">
                ...
                {hasStreakShield && (
                  <span className="text-[10px] font-bold text-synth-cyan border border-synth-cyan/40 px-1.5 py-0.5 rounded font-orbitron">
                    Đang kích hoạt ✓
                  </span>
                )}
              </div>
            ...
            <button
              ...
              className={`ml-3 px-4 py-2.5 rounded-xl font-orbitron font-bold text-xs uppercase tracking-wider cursor-pointer transition-all duration-300 disabled:opacity-40 disabled:cursor-not-allowed ${
                isUnicorn
          ...
          <div className={`glass-panel rounded-2xl p-5 flex justify-between items-center ${
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="space-y-1">
                ...
                <span className={`text-[10px] font-bold font-orbitron ${isUnicorn ? 'text-fuchsia-600' : 'text-synth-magenta'}`}>
          ...
          <div className={`glass-panel rounded-2xl p-5 flex justify-between items-center ${
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="space-y-1">
                ...
                <span className={`text-[10px] font-bold font-orbitron ${isUnicorn ? 'text-amber-600' : 'text-synth-orange'}`}>
            ...
            <button
              ...
              className={`ml-3 px-4 py-2.5 rounded-xl font-orbitron font-bold text-xs uppercase tracking-wider cursor-pointer transition-all duration-300 ${
                isUnicorn
      ...
      {/* 🎁 Phúc Lợi Gia Môn */}
      <div>
        <h3 className={`font-orbitron font-bold text-sm uppercase tracking-wider mb-4 flex items-center gap-2 ${isUnicorn ? 'text-violet-700' : 'text-synth-orange'}`}>
          <Gift className="w-4 h-4" /> 🎁 Phúc Lợi Gia Môn
        </h3>

...
- [x] **F51 — Giữ nguyên trang cũ (active screen) sau khi F5 refresh**
  - *Mục tiêu:* Đảm bảo khi học sinh bấm F5 refresh trình duyệt, giao diện không bị quay về trang mặc định (WorldMap) mà được khôi phục chính xác về trang đang mở trước đó (rèn luyện, Cửa hàng, v.v.).

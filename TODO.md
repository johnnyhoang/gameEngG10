...
Tài liệu này lưu trữ định hướng phát triển các tính năng học tập mới cho **Đấu trường**, **Hang luyện công** hoặc khu vực mới **Khu thư giãn** để bổ sung dần vào dự án.

---

## 🏛️ Đấu trường (Arena) & 🕳️ Hang luyện công (Training Cave)
...
- [ ] **🧠 Active Recall (Nhớ chủ động)**
  ...
  - *Phân bổ phù hợp:* **Hang luyện công** (Luyện tập cá nhân) hoặc **Đấu trường** (Flashcard tốc độ).

- [ ] **🧩 Step Builder (Sắp xếp các bước)**
...
- [ ] **✍️ Explain to AI (Giải thích cho AI)**
  ...
  - *Phân bổ phù hợp:* **Hang luyện công** hoặc nâng cao tại **Đấu trường** (Màn đấu Boss tự luận).

- [ ] **📚 Teach the AI (Dạy học cho AI)**
  ...
  - *Phân bổ phù hợp:* **Hang luyện công** (Chế độ tự luyện nâng cao học thuyết Feynman).

- [ ] **🧱 Drag & Drop Diagram (Kéo thả sơ đồ)**
  - *Mô tả:* Kéo thả nhãn, công thức hoặc thành phần vào đúng vị trí trên hình vẽ, sơ đồ khoa học hoặc biểu đồ địa lý/lịch sử.
  - *Phân bổ phù hợp:* **Hang luyện công** (Minh họa trực quan hình học phẳng/3D).

- [ ] **⚔️ Boss Battle (Quyết đấu Boss)**
  ...
  - *Phân bổ phù hợp:* **Đấu trường** (Chế độ đấu Boss cuối tuần/môn học).

---

## 🦄 Khu thư giãn (Relaxation Zone) - KHU VỰC MỚI

Các tính năng mang tính chất tương tác nhẹ nhàng, kết hợp học tập trực quan và khám phá cốt truyện giải trí:

- [ ] **🔗 Match Pairs (Ghép cặp bài trùng)**
  ...
  - *Phân bổ phù hợp:* **Khu thư giãn** (Game ghép thẻ bài nhanh) hoặc **Hang luyện công** (Khởi động bài học).

- [ ] **🗺️ Mind Map Builder (Xây dựng Sơ đồ tư duy)**
  ...
  - *Phân bổ phù hợp:* **Khu thư giãn** (Góc sáng tạo) hoặc công cụ tóm tắt bài học trong **Hang luyện công**.

- [ ] **🎭 Story / Scenario Mode (Học qua cốt truyện)**
  ...
  - *Phân bổ phù hợp:* **Khu thư giãn** (Đọc truyện tương tác) hoặc mở đầu chiến dịch ở **Đấu trường**.

- [ ] **🧭 Adventure Journey (Hành trình phiêu lưu)**
  ...
  - *Phân bổ phù hợp:* **Khu thư giãn** / Bản đồ thế giới mở (Hệ thống điều hướng chính thay thế bản đồ tĩnh).
...
- [ ] **📐 Định nghĩa type `CoreKnowledgeTopic` trong `src/types/game.ts`**
...
- [ ] **📦 Tạo file `src/data/coreKnowledge.ts` — Bảng danh mục 99 chuyên đề**
  - Export hằng số `CORE_KNOWLEDGE_TOPICS: CoreKnowledgeTopic[]` chứa đầy đủ 99 chuyên đề cho 9 môn phái.
  - Nhóm Chuyên Sâu: 19 chuyên đề Tiếng Anh + 18 chuyên đề Toán + 13 chuyên đề Ngữ Văn.
  - Nhóm Cơ Bản: 14 KHTN + 12 Lịch Sử-Địa Lý + 6 GDCD + 5 Công Nghệ + 6 Tin Học + 6 Nghệ Thuật.
  - Export hàm `getTopicsBySubject(subjectId)`, `getTopicsByHam(ham)`, `getTopicById(id)`.
  - *Phạm vi:* `src/data/coreKnowledge.ts` (file mới)

- [ ] **🔗 Retrofit field `topicId` vào `questions.ts` hiện có**
...
### 9.B — Coverage Dashboard (Thiên Cơ Các — Bảng Quản Trị)

- [ ] **📊 Coverage Alert Component — Cảnh báo chuyên đề thiếu câu hỏi**
  - Tạo component trong Thiên Cơ Các (Admin Console) hiển thị danh sách chuyên đề `examRelevance = 'high'` đang thiếu câu hỏi (< `minQuestions`).
  - Màu đỏ/vàng/xanh theo mức độ: <50% minQuestions = đỏ, 50–99% = vàng, ≥100% = xanh.
  - Nút shortcut "Import thêm câu" dẫn thẳng vào Vạn Quyển Các filter theo chuyên đề đó.
  - *Phạm vi:* Admin console UI (Thiên Cơ Các panel)

- [ ] **📈 Progress Bar theo môn phái trong Thiên Cơ Các**
...
- [ ] **🏷️ Giao diện Tag Chuyên Đề khi Import/Edit câu hỏi**
  ...
  - *Phạm vi:* Vạn Quyển Các — Question form UI

- [ ] **🤖 AI Auto-Tag khi Import đề từ File (mở rộng AI Ingest §4.1)**

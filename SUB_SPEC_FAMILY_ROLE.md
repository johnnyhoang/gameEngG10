...
*   **Phân chia tab chính:**
    1.  `Thiếu Hiệp`: Danh sách học sinh.
...
*   **Phân quyền hiển thị theo vai trò (Role-based filtering):**
    *   **Giáo viên (Chủ nhiệm/Phụ):** Chỉ được nhìn thấy học sinh trong phạm vi các lớp mình phụ trách. Tab `Thiếu Hiệp` của giáo viên chia thành 2 sub-tabs:

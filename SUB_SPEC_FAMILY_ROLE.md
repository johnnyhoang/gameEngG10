...
*Cập nhật: 2026-07-11 — Bổ sung cơ chế duyệt ứng tuyển Hiệu phó, Xin đồng hành và Roster phân quyền*
...
#### 🌱 Học Sinh (Student)
- **Code value:** `'student'`
- **Thuật ngữ UI:** Môn Sinh 🌱
- Là trung tâm của ứng dụng. Tham gia giải bài, kiếm XP/NP, nuôi thú ảo.
- Chỉ có quyền truy cập vào Môi trường Môn Sinh (World Map, Đấu Trường, Hang Luyện Công...).
...
4.  **Ứng Tuyển Làm Hiệu Phó Trường Học:** Giáo viên tự nộp đơn ứng tuyển làm Hiệu Phó của trường. Đơn này xuất hiện công khai trên trang quản trị Thiên Cơ Các của Hiệu Trưởng để phê duyệt (hoặc từ chối) trực tiếp, giúp lược bỏ quy trình liên hệ/gửi email tay rườm rà.
...
Bảng Roster trong Thiên Cơ Các (`SettingsManager.tsx`) thay thế hoàn toàn bảng xếp hạng Leaderboard cũ, đóng vai trò là sổ quản lý nhân sự phân quyền:
*   **Phân chia tab chính:**
    1.  `Môn Sinh`: Danh sách học sinh.
    2.  `Chủ Nhiệm`: Danh sách giáo viên chủ nhiệm chính.
    3.  `Đồng Hành`: Danh sách giáo viên phụ hỗ trợ.
    4.  `Ban Giám Hiệu`: Danh sách Hiệu Trưởng và Hiệu Phó.
*   **Phân quyền hiển thị theo vai trò (Role-based filtering):**
    *   **Giáo viên (Chủ nhiệm/Phụ):** Chỉ được nhìn thấy học sinh trong phạm vi các lớp mình phụ trách. Tab `Môn Sinh` của giáo viên chia thành 2 sub-tabs:
...
*   **Các cột hiển thị chi tiết:**
    ...
    *   *Ban giám hiệu:* Tên & Avatar, Email, Vai trò (Hiệu Trưởng hoặc Hiệu Phó).

...
| 2 | **Chủ Nhiệm Chính** (`parent`) | Tự tạo | Admin set `is_active = false` | ✅ Có |
...
4. UI ParentConsole: phân biệt badge Viện Trưởng vs. Phó Viện Trưởng, thêm nút "Bổ nhiệm Phó Viện Trưởng".

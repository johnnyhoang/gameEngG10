...
*   **Chuyển đổi toàn cục (Global Switch):** Học sinh chỉ có thể thay đổi môn phái tại **duy nhất một nơi**: thẻ môn phái trong trang **Thân Phận** (`ProfileThemeModal`, xem §7.4). Thanh HUD (`TopHUD`) **không** đặt bộ chuyển đổi/dropdown môn phái nữa — để tránh 2 nơi cùng làm 1 việc, HUD chỉ hiển thị 1 chấm màu nhỏ theo màu môn phái đang hoạt động gắn trên nút "Thân Phận" (bấm nút này để mở Thân Phận và đổi môn tại đó). Khi học sinh thực hiện chuyển đổi môn phái, toàn bộ môi trường ứng dụng (chủ đề màu neon chủ đạo, bản đồ đảo, nhiệm vụ ngày, dòng sự kiện và dữ liệu câu hỏi trong PlayArea) sẽ chuyển đổi đồng loạt sang môn phái mới được chọn.

...
Toàn bộ thế giới giang hồ được phân tầng theo **lớp học (grade)** — mỗi lớp là **một Bậc Học** độc lập:
...
*   **Xưởng Toán Đồ Thị (BikiDoThiHamSo):** Vẽ đồ thị parabol ($y = ax^2 + bx + c$) và đường thẳng ($y = mx + n$). Cho phép kéo thanh trượt (slider) hệ số để quan sát sự thay đổi tiêu cự, đỉnh, giao điểm trực quan theo thời gian thực.
...
*   🛡️ **Thẻ Chuyên Cần:** Duy trì chuỗi tu luyện (Streak) khi bỏ lỡ một ngày, tránh bị reset chuỗi (trước đây gọi là Khiên giữ chuỗi / Streak Shield).
...
*   **Cơ Chế "Thú Về Chuồng" (Pet Stable & Overlay)**:
    ...
    *   **Các thời điểm heo xuất hiện** (dưới dạng **overlay đè lên layout hiện tại**, nền phía sau làm mờ nhẹ để tập trung vào heo):
        ...
        2.  *Gác Cổng lúc đăng xuất (Logout Gate — "Rời Học Viện"):* Khi Sĩ Tử bấm **Rời Học Viện** (Đăng xuất), Heo xuất hiện mang theo một trang Cẩm Nang khác để dặn dò trước khi rời giang hồ. Để tránh giữ chân cưỡng ép (dark pattern), Sĩ Tử hoặc Chủ nhiệm có thể bấm nút "Rời học viện ngay" để hoàn tất đăng xuất ngay lập tức mà không bắt buộc phải thực hiện thọt lét/tương tác thú cưng.
...
Hồ sơ cá nhân của Sĩ Tử — nơi tra cứu tiến trình tu luyện:
...
*   **Danh hiệu & tiến trình chung:** Danh hiệu kiếm hiệp (Tân Đệ Tử, Đệ Tử, Sĩ Tử...) ánh xạ từ Level (§7.2), badges và lịch sử truyền công.
*   **Cổng hành động chuyển màn nhanh (Exit Gates):** 2 nút ở chân trang — 🚪 *Bôn Tẩu Giang Hồ* (về Bản Đồ) và ⚔️ *Vào Học Đường* (đi thẳng vào luyện tập theo môn phái vừa chọn).
...
*   👑 **Hồ Sơ Sĩ Tử:** Hồ sơ cá nhân của Sĩ Tử (profile), hiển thị danh hiệu kiếm hiệp (Tân Đệ Tử, Đệ Tử, Sĩ Tử...), cấp độ tu học, badges và lịch sử truyền công.
...
### 2.7 📖 Cẩm Nang Học Đường (Giang Hồ Cẩm Nang)
...
Toàn bộ không gian điều hướng của Sĩ Tử sẽ được mô hình hóa lại thành một cây **Page 3 tầng** (Cấp 1 → Cấp 2 → Cấp 3) thay vì các "màn hình" rời rạc như hiện tại. Mỗi Page (từ Cấp 2 trở xuống) là một điểm có thể **khám phá (explore)** và ghi lại dấu vết tu luyện riêng theo từng Sĩ Tử, phục vụ nhiều mục đích game hóa (gợi ý ôn tập, thành tựu khám phá bản đồ, heatmap cho Viện Trưởng...).

### 2.8.1 Cấp 1 — Các Page gốc (ngang hàng, không lồng nhau)
Trùng với các module chính/phụ đã có ở §2.1, tất cả đều **ngang cấp**, không có page nào là "vùng con" của page khác: **Bản Đồ (WorldMap)**, **Trường Thi**, **Học Đường**, **Công Viên Thư Giãn**, **Shop Học Cụ**, **Sân Thú Nuôi**, **Hồ Sơ Sĩ Tử**.

> ✏️ *Sửa so với bản nháp trước:* Công Viên Thư Giãn, Shop Học Cụ, Sân Thú Nuôi **không phải** là loại "vùng" (Mật Cảnh) nằm bên trong Bản Đồ Lớn — đã bỏ hẳn cách phân loại đó. Cả 3 đều là Page Cấp 1 độc lập, ngang hàng với WorldMap/Trường Thi/Học Đường.
...
*   **Mobile:** đã tồn tại sẵn dưới dạng **thanh điều hướng dưới cùng (Bottom Navigation)** — persistent trên mọi màn hình (`App.tsx`), gồm 5 nút 🗺️ Bản Đồ / ⚔️ Trường Thi / 📚 Hang / 🏮 Bách Hóa / 🐷 Sân Thú Nuôi. Vì đây là chrome dùng chung toàn app (không nằm trong nội dung riêng của từng trang), **mọi Page Cấp 1 trên mobile đã có sẵn Vùng Điều Hướng Trung Tâm**, kể cả Học Đường và Công Viên Thư Giãn.
*   **Desktop:** **chưa đạt độ phủ tương đương mobile**. Chỉ chính trang WorldMap có đủ lưới 5 cổng (`WorldMap.tsx`); các trang còn lại chỉ có nav rút gọn qua `TopHUD` (nút Bách Hóa, Học Đường, Hồ Sơ Sĩ Tử + logo bấm về Bản Đồ) — thiếu cổng trực tiếp sang Trường Thi và Sân Thú Nuôi từ mọi trang. Đây là gap thật cần bổ sung.
...
| 🕳️ **Học Đường** | ✅ Bottom Nav | ✅ Đã có Desktop Central Nav | Mật Thất, Hầm, Rương — xem §2.8.3 |
| 🦄 **Công Viên Thư Giãn** | ✅ Bottom Nav | ✅ Đã có Desktop Central Nav | 3 Cảnh (Hoa Viên/Núi Rừng/Thác Hồ) — xem §2.8.3 |
| ⚔️ **Trường Thi** | ✅ Bottom Nav | ✅ Đã có Desktop Central Nav | *(chưa định nghĩa — TODO)* |
| 🏮 **Shop Học Cụ** | ✅ Bottom Nav | ✅ Đã có Desktop Central Nav | *(chưa định nghĩa — TODO)* |
| 🐷 **Sân Thú Nuôi** | ✅ Bottom Nav | ✅ Đã có Desktop Central Nav | *(chưa định nghĩa — TODO)* |

> ⚠️ *Điểm cần xác nhận lại:* yêu cầu gốc nói vùng trung tâm của WorldMap có "4 component link qua 4 trang còn lại", nhưng theo cấu trúc 5 module đã triển khai thực tế (§2.1) và đúng như Bottom Nav mobile hiện có, WorldMap có 5 cổng (Trường Thi/Hang/Sơn Trang/Bách Hóa/Sân Thú Nuôi). Tạm ghi nhận theo đúng thực tế code (5 cổng) — nếu ý user là con số 4 có chủ đích khác thì cần nói rõ ở đợt sau.

### 2.8.3 Cấp 2 — Page con nội dung thật sự theo từng Page Cấp 1

#### Học Đường → 3 loại Page con

| Loại | Ý nghĩa | Thành phần hiện tại map vào |
| :--- | :--- | :--- |
| 🔮 **Kho Nền Tảng** | Khu tập hợp các xưởng Toán tương tác sâu | Xưởng Toán Hình 3D, Xưởng Toán Hình và Xưởng Toán Đồ Thị (hiện chỉ đủ 3 xưởng cho Toán, xem §2.1/§1.3) |
| 🕳️ **Hầm** (Tối đa 10 Hầm nguyên tố) | Không gian luyện tập theo Chuyên đề của Môn học | "Hầm Ngục Chuyên Đề" được sinh động hóa thành tối đa 10 Hầm nguyên tố (Thạch, Hỏa, Băng, Phong, Lôi, Thủy, Mộc, Kim, Quang, Ám) tương ứng với các phân mục SGK (`loai`) của môn học đó. Hầm không có bài học sẽ tự động ẩn. |
...
> 📌 **Quy Tắc Phân Tầng Kiến Thức & Gán Hầm:**
> Hệ thống áp dụng cấu trúc phân tầng tối ưu theo sách giáo khoa (SGK):
> *   **Tầng 1 (Môn học):** Toán, Anh, Văn...
> *   **Tầng 2 (Loại - Category):** Đại Số, Hình Học & Đo Lường, Thống kê & Xác suất... Mỗi Loại được ánh xạ vào một Hầm nguyên tố phù hợp (ví dụ: Toán `Đại số` -> Thạch Hầm, `Hình học và Đo lường` -> Hỏa Hầm, `Thống kê và Xác suất` -> Băng Hầm).
> *   **Tầng 3 (Bài - SGK):** Đánh số tuần tự `Bài 1`, `Bài 2`, `Bài 3`... từ dễ đến khó. Các bài học trong mỗi Hầm được tự động sắp xếp tăng dần theo thuộc tính `bai`.
> *   **Tầng 4 (Topic - Chuyên đề cốt lõi):** Gắn ngầm dưới dạng nhãn (Tag) vào bài giảng/câu hỏi để quản lý ngầm độ phủ ngân hàng câu hỏi (Coverage) và đánh giá độ hiểu của học sinh (AI Sư Phụ).
> *   **Cơ chế gán tự động bài tự do:** Bài học do Viện Chủ tạo thêm hoặc ngoài danh mục SGK sẽ tự động được gán số bài nối tiếp (`Max + 1`, `Max + 2`...) và xếp ở cuối Hầm.

#### Công Viên Thư Giãn → 3 Cảnh
...
#### Trường Thi, Shop Học Cụ, Sân Thú Nuôi, WorldMap
...
| :--- | :--- | :--- |
| 🗺️ **WorldMap** | 📜 Bảng Bài Tập (Daily Quest) <br> 🏛️ Tàng Kinh Các Phân Đà (AI Sư Phụ) | Các nhiệm vụ ngày cụ thể. <br> Bài học được AI đề xuất riêng biệt. |
| ⚔️ **Trường Thi** | 🏅 Trường Thi Xếp Hạng (Ranked) <br> 🐲 Lôi Đài Thần Thú (Boss Raid) <br> 🛡️ Vực Sinh Tồn (Survival) | Đỉnh Ngữ Pháp, Tháp Từ Vựng... <br> Từng con Boss cụ thể. <br> Từng mốc Tầng sinh tồn (Tầng 1, Tầng 2). |
| 🏮 **Shop Học Cụ** | 📜 Quầy Học Cụ <br> 🎭 Phong Cách Học Đường <br> 🎁 Quầy Quà Khuyến Học | Thẻ Nhắc Bài, Thẻ Chuyên Cần... <br> Đào Hoa, Tinh Không, Trúc Lâm... <br> Từng Quà Khuyến Học do Chủ Nhiệm tạo (§3.2). |
...
**Ví dụ minh họa** (theo đúng kịch bản user đặt ra): Thuý Nga vào **Học Đường** (Cấp 1) lúc 14:00 hôm qua → khám phá **Mật Thất Ngữ Pháp** (Cấp 2, loại `mat_that`) → khám phá 3 Page lá Cấp 3 (Verb Tense, Passive Voice, Relative Clause). 19:00 cùng ngày quay lại Mật Thất Ngữ Pháp, khám phá thêm 2 Page con mới.
...
**Mục đích sử dụng dữ liệu** (định hướng, chưa triển khai): AI Sư Phụ gợi ý ôn lại vùng có `lastExploredAt` cũ nhất; thành tựu "đã khám phá X% Học Đường"; Viện Trưởng xem heatmap con học nhiều/ít ở đâu; sự kiện Thử Thách Bất Ngờ (§3.C) ưu tiên xuất hiện ở vùng ít được khám phá.
...
3.  *(Đã xong)* Định nghĩa Page con Cấp 2 cho Trường Thi, Shop Học Cụ, Sân Thú Nuôi.
...
*   **Học tập:** Giải bài tập / Vượt ải -> Nhận XP & Ruby -> Chăm sóc Pet & Mua vật phẩm.
...
2. **Luật Ruby:** Các hành động chủ ý có chi phí (mua học cụ, chăm MIKA, mở phong cách, đổi quà) chỉ thực hiện khi đủ Ruby; không cho tiêu âm. Khoản trừ bắt buộc khác phải được đặc tả riêng và không áp dụng cho **Miễn Phạt**.
...
#### Cơ Chế "Miễn Phạt" (Bỏ Qua Thử Thách)
- Sĩ Tử được dùng **Miễn Phạt** để bỏ qua câu hỏi khó, tối đa **3 lượt mỗi ngày**.
- Miễn Phạt **không trừ Ruby** và không phụ thuộc số dư Ruby.
...
*   **Nơi sử dụng:** Hồ Sơ Sĩ Tử (học sinh tự xem), báo cáo Chủ nhiệm, dashboard Phòng Học Vụ, và là chỉ số xương sống của hệ thống Leaderboard (§7.5). Đây là thước đo "north star" của sản phẩm: *tổng phút tu luyện thu hoạch mỗi ngày/tuần*.
...
*   **Bố cục Thanh HUD (`TopHUD`):** Để tránh rối mắt (nhiều box chồng lấn, cao thấp lộn xộn), thanh HUD gom nhóm thông tin thành các **khối gộp có cùng chiều cao** thay vì rải rác từng chỉ số riêng lẻ:
    ...
    *   *Khối Tài Nguyên:* 1 khối duy nhất gồm Ruby và Chuỗi luyện công (kèm icon Thẻ Chuyên Cần nếu có) — các chỉ số kinh tế/tiến trình gộp chung 1 nơi, phân cách bằng vạch mảnh, không dùng nhãn chữ 2 dòng (chỉ icon + số + tooltip) để tiết kiệm không gian. *(Tim sinh mệnh và Ví Thưởng VND đã bị xóa bỏ khỏi hệ thống — xem §2.1 và §3.2.)*
...
*   **Bố cục "Chuồng Heo" thay thế cột thú cố định**: Cột trái `aside w-72` chiếm chỗ Heo Maikawaii thường trực trên desktop bị loại bỏ. Thay vào đó:
    ...
    *   *Re-layout diện rộng:* Sơn Trang/Bản Đồ (`GameMap`), Shop Học Cụ, Học Đường, Lầu Thư Giãn được thiết kế lại bố cục lưới/card để tận dụng phần không gian trước đây dành cho cột thú — nhiều cột hơn, card lớn hơn, hiển thị nhiều thông tin hơn trên cùng một màn hình.
...
| **Primary Parent** | **Chủ Nhiệm Chính** 👨‍👩‍👧 | `parent` | Người chịu trách nhiệm chính của Lớp Chủ Nhiệm — tạo phần thưởng, giao nhiệm vụ, cấu hình Năng Lượng và quản lý học sinh. |
| **Secondary Parent** | **Chủ Nhiệm Phụ** 👤 | `secondary_parent` | Được Viện Trưởng mời — quyền do Viện Trưởng cấu hình bật/tắt từng mục. |
| **Teacher / Content Creator** | **Giảng Sư** 📖 | `teacher` *(future)* | Thầy cô truyền dạy võ học và kiến thức của các môn phái. |
...
| **Student / Player** | **Sĩ Tử** 🌱 | `student` | Cách gọi chung cho người học tham gia tu luyện. |
...
| ⚔️ **Sĩ Tử** | `⚔️` | **Level 15 - 29** | 21.000 | Có nền tảng vững vàng, đã tự mình vượt qua nhiều thử thách. |
| ⭐ **Cao Thủ** | `⭐` | **Level 30 - 49** | 87.000 | Đạt được những thành tích nổi bật và độ chính xác cao khi giải bài. |
| 🐉 **Đại Hiệp** | `🐉` | **Level 50 - 79** | 245.000 | Võ công thượng thừa, nằm trong danh sách các Sĩ Tử đứng đầu môn phái. |
...
2.  **Định nghĩa Hàm tiện ích:**
    ...
    export const STUDENT_RANKS: StudentRank[] = [
      ...
      { id: 'thieu-hiep', name: 'Sĩ Tử', icon: '⚔️', minLevel: 15, description: 'Có nền tảng vững vàng...' },
...
Để Sĩ Tử đánh giá chính xác mức độ đầu tư tu luyện của mình trên từng môn học cụ thể (biết phái nào luyện ít, cần luyện thêm), hệ thống áp dụng hệ thống Đẳng cấp Môn phái độc lập dựa trên tỉ lệ hoàn thành bài học và câu hỏi:
...
| 👨‍👩‍👧 **Chủ nhiệm Chính** | ParentConsole | Xếp hạng các con trong nhóm mình — theo Phút Đèn Sách, Điểm kiếm/kỳ, tỉ lệ đúng, số chuyên đề đạt Tinh Thông, số lần Skip. |

...
*   **Quyết đấu Boss (Boss Battle):** Đấu trường thi thử theo thời gian thực (20 phút). Đề Boss được **trích chọn từ đề thi thật** các năm (2024, 2025, 2026): mỗi đề thật số hóa được ~20 câu, mỗi lượt Boss chỉ rút **5 câu** (~1/5 đề). Phần thưởng quy hết về **Điểm**: điểm trên từng câu đúng + một khoản **bonus hoàn thành lớn** được quảng bá ngay trên Boss Card, mức bonus do **Chủ Viện / Phó Viện** quy định. Boss **không thưởng tiền** dưới bất kỳ hình thức nào.
...
Xuất hiện tại Vùng Điều Hướng Trung Tâm (World Map Hub). Đây là nơi hiển thị các **Nhiệm vụ do Phụ huynh giao**.
- Phụ huynh có thể tạo nhiệm vụ dựa trên tài nguyên có sẵn (Ví dụ: "Làm xong 5 bài Toán", "Đạt 100 điểm Tiếng Anh").
- Khi học sinh hoàn thành, sẽ nhận được phần thưởng NP lớn (hoặc quà thực tế) do phụ huynh thiết lập.
...
*   🎁 **Phúc Lợi Gia Môn:** Đổi Ngân lượng lấy các Phần Thưởng Thực Tế do phụ huynh tạo, có số lượng giới hạn — cơ chế chi tiết xem §3.2.
...
*   **Cơ Chế "Thú Về Chuồng" (Pet Stable & Overlay)**:
    ...
    *   **Các thời điểm heo xuất hiện** (dưới dạng **overlay đè lên layout hiện tại**, nền phía sau làm mờ nhẹ để tập trung vào heo):
        ...
        2.  *Gác Cổng lúc đăng xuất (Logout Gate — "Rời Học Viện"):* Khi thiếu hiệp bấm **Rời Học Viện** (Đăng xuất), Heo xuất hiện mang theo một trang Cẩm Nang khác để dặn dò trước khi rời giang hồ. Hành động đăng xuất chỉ thực sự hoàn tất **sau khi** heo được cho về chuồng (xem quy tắc dismiss chung bên dưới). Mốc này được thiết kế là **lời chào tạm biệt 1 chạm** — thọt lét 1 cái là đi được ngay, tuyệt đối không nhét thêm nội dung bắt đọc dài ở cửa ra.
        ...
        6.  *Báo hết Chân Khí (Energy Depleted):* Khi Chân Khí của thiếu hiệp về 0, heo xuất hiện thông báo đã hết năng lượng, phải nghỉ ngơi, kèm thời điểm hồi lại — chi tiết luật hồi xem **[SUB_SPEC_ENERGY.md](./SUB_SPEC_ENERGY.md)**.
    ...
    *   **Chống dồn dập (anti-spam):** Các trigger tự động (idle/đói/hết chân khí) dùng chung một cooldown tối thiểu 10 phút giữa các lần bật overlay tự động — dismiss vì lý do này không cho phép lý do khác bật lại overlay ngay sau đó.
    *   **Kỷ luật thi cử — không phá bĩnh giữa trận:** Khi thiếu hiệp đang trong trận đấu (Đấu Trường / Boss / đang làm bài luyện tập), mọi trigger tự động (idle/đói/hết chân khí) bị **hoãn lại**, dồn tích và chỉ hiện ra ngay khi thiếu hiệp thoát về Sơn Trang/Bản Đồ. Trigger triệu hồi thủ công vẫn bị khóa trong lúc làm bài như hiện tại.
...
Hồ sơ cá nhân của thiếu hiệp — nơi tra cứu tiến trình tu luyện:
...
*   **Quyền quản trị của Viện Chủ:** Viện Chủ có thể nạp thêm các trang dặn dò (Quy định riêng của gia đình, nhắc nhở ôn bài, lịch học thực tế) vào cuốn cẩm nang. Các trang mới này tự động được đưa vào vòng random mà heo mang ra tại các mốc Gác Cổng.
...
- **Cảnh báo thoát giữa chừng:** Khi thiếu hiệp đang làm dở bài và bấm thoát ra Bản Đồ, một popup đơn giản sẽ hiện lên nhắc nhở: *"Nếu con không hoàn tất, vài hôm nữa khu vực này sẽ bị sương mù che phủ lại đấy!"*. Tùy chọn: Ở lại làm tiếp hoặc Vẫn Thoát.
...
| 🏮 **Bách Hóa Phường** | 💊 Quầy Linh Đan & Bùa Chú <br> 👘 Tiệm Y Phục (Themes) <br> 🎁 Quầy Phúc Lợi Gia Môn | Khai Ngộ Quyển, Hộ Tâm Phù... <br> Đào Hoa, Tinh Không, Trúc Lâm... <br> Từng Phần Thưởng Thực Tế do phụ huynh tạo (§3.2). |
...
- **Trạng thái Tạm thời & Pet Gác Cổng:** Khi bấm vào khu vực mờ sương, **Thú cưng (Heo Maikawaii) sẽ xuất hiện làm Người Gác Cổng** và hỏi một câu kiến thức cốt lõi. Câu hỏi **bắt buộc là Trắc nghiệm (MCQ)** với độ khó chuẩn hóa **2/5**; nội dung là các công thức, định nghĩa, định luật — core knowledge của đúng **Tầng lớp học** (§1.4) và **Môn phái** tương ứng; không yêu cầu tính toán dài hay gõ chữ. 
  - Nếu trả lời đúng: Tặng NP nhỏ, sương mù tan tạm thời và con có thể vào học.
  - Nếu trả lời sai: Bị trừ lượng nhỏ NP, câu hỏi mới sẽ xuất hiện ngay lập tức. Quá trình mở khóa chỉ tốn vài cú click và một chút trí nhớ.
...
*   **Đổi quà:** Dùng Điểm (NP) đổi Phần Thưởng Thực Tế có số lượng giới hạn -> Phụ huynh xác nhận "Đã Trao" -> Nhận quà ngoài đời (§3.2).
...
- Thiếu Hiệp được quyền Bỏ qua (Skip) câu hỏi khó. **Không giới hạn số lần Skip trong ngày**.
- Tuy nhiên, mỗi lần Skip sẽ bị **trừ một lượng nhỏ Ngân lượng (NP)**.
- **Vấn Tội trước khi Bỏ qua:** Khi bấm "Bỏ qua câu này", một popup cảnh báo (đúng luật Minimalism) sẽ hiện ra báo rằng Thiếu Hiệp sẽ bị trừ NP. Bắt buộc chọn 1 lý do: 🥵 Quá khó, 📜 Quá dài, 🤪 Lỗi đề.
- Lý do này được ghi nhận lại để Viện Chủ xem xét điều chỉnh chất lượng Câu hỏi trong ngân hàng.
...
*   **Phụ huynh tự tạo Phần Thưởng:** Mỗi phụ huynh tự tạo danh mục phần thưởng riêng và tự định giá bằng NP. Ví dụ: 1 ly trà sữa 25.000đ = 500 NP; bao lì xì tiền mặt 10k / 20k / 50k = mức NP tùy phụ huynh đặt. Chỉ các con thuộc nhóm gia đình của phụ huynh đó **thấy được và đổi được** danh mục này.
*   **Số lượng giới hạn (khan hiếm có chủ đích):** Mỗi phần thưởng có số lượng cụ thể (ví dụ: 10 bao lì xì 10k, 4 ly trà sữa). Ai kiếm đủ điểm đổi sớm thì lấy trước; mỗi lần đổi số lượng giảm xuống, hết là thôi. Đây đồng thời là **van an toàn ngân sách** cho giáo viên/phụ huynh — tổng chi tối đa luôn biết trước.
*   **Luồng trao thưởng ngoài app:** Đổi quà = trừ NP của thiếu hiệp + tạo một yêu cầu chờ trao. Việc trao quà diễn ra hoàn toàn **ngoài đời thực**; phụ huynh bấm nút **"Đã Trao"** để đóng yêu cầu. Không có bất kỳ giao dịch tiền nào chạy bên trong hệ thống.
*   **Boss không thưởng tiền:** phần thưởng Boss quy hết về Điểm + bonus hoàn thành cấu hình bởi Chủ Viện / Phó Viện (xem §2.1).
...
| ⚔️ **Thiếu Hiệp** | `⚔️` | **Level 15 - 29** | 21.000 | Có nền tảng vững vàng, đã tự mình vượt qua nhiều thử thách. |
| ⭐ **Cao Thủ** | `⭐` | **Level 30 - 49** | 87.000 | Đạt được những thành tích nổi bật và độ chính xác cao khi giải bài. |
| 🐉 **Đại Hiệp** | `🐉` | **Level 50 - 79** | 245.000 | Võ công thượng thừa, nằm trong danh sách các thiếu hiệp đứng đầu môn phái. |
...
4.  **Luật Bất Thoái (One-way Mastery):** Đẳng cấp môn phái **đã đạt sẽ không bao giờ tự tụt** — kể cả khi Viện Chủ import thêm câu hỏi/bài học làm mẫu số của công thức tăng lên. Hệ thống lưu đẳng cấp cao nhất từng đạt (`maxAchievedRank`) theo từng môn phái và luôn hiển thị mức cao nhất đó. Tỉ lệ % chi tiết bên dưới đẳng cấp vẫn phản ánh số thực để thiếu hiệp biết còn bao nhiêu nội dung mới.
...
| **Phần Thưởng Thực Tế** 🎁 | Reward Catalog | `parentReward` / `rewardQuantity` / `markRewardDelivered` | Phần thưởng do phụ huynh tự tạo, định giá bằng NP, có số lượng giới hạn, trao ngoài đời qua nút "Đã Trao" (§3.2). |
...
| **Chủ Viện / Phó Viện** 🏛️ | Admin / Moderator | `admin` / `moderator` | Hệ phân quyền quản trị mới nhiều cấp (spec chi tiết đang cập nhật bên Gemini — §1.2). |
| **Bảng Cáo Thị** 📜 | Parent Quests | `parentQuest` | Nhiệm vụ do phụ huynh giao, hiển thị tại Vùng Điều Hướng Trung Tâm của WorldMap. |
...
| **Chân Khí** ⚡ | Energy | `energy` / `maxEnergy` / `resetHours` | Thể lực tiêu hao khi làm hoạt động sinh điểm; max và thời gian hồi (2/3/5h) do phụ huynh cấu hình — luật chi tiết tại [SUB_SPEC_ENERGY.md](./SUB_SPEC_ENERGY.md). |
...
interface CoreKnowledgeTopic {
  ...
  description: string;         // mô tả ngắn cho Viện Chủ khi import đề
}
```
...
- Câu hỏi người gác cổng (Gatekeeper) khi Thiếu Hiệp muốn vào khu vực mờ sương **bắt buộc phải thuộc nhóm chuyên đề** được gán cho Hầm đó.
...
Ngoài các quy tắc AI Ingest (§4.1), khi Viện Chủ import câu hỏi vào ngân hàng, hệ thống bắt buộc phải:
...
2. **Kiểm tra `examRelevance`:** Khi Viện Chủ import đề từ file Word/PDF, AI phân tích và đề xuất `examRelevance` (HIGH/MEDIUM/LOW) dựa trên tần suất xuất hiện trong các đề tuyển sinh/HK gần nhất.

3. **Phân loại `hamNguyenTo` tự động:** Hệ thống tự động gán `hamNguyenTo` dựa trên `topicId` theo bảng gán §9.5. Viện Chủ có thể override.

4. **Cảnh báo thiếu câu hỏi (Coverage Alert):** Nếu một chuyên đề có `examRelevance = 'high'` nhưng số câu trong DB < `minQuestions`, Bảng Quản Trị (Thiên Cơ Các §2.6) hiển thị cảnh báo đỏ nhắc Viện Chủ bổ sung.

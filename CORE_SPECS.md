...
Toàn bộ không gian điều hướng của Sĩ Tử sẽ được mô hình hóa lại thành một cây **Page 3 tầng** (Cấp 1 → Cấp 2 → Cấp 3) thay vì các "màn hình" rời rạc như hiện tại. Mỗi Page (từ Cấp 2 trở xuống) là một điểm có thể **khám phá (explore)** và ghi lại dấu vết học tập riêng theo từng Sĩ Tử, phục vụ nhiều mục đích game hóa (gợi ý ôn tập, thành tựu khám phá bản đồ, heatmap cho Viện Trưởng...).
...
| 🕳️ **Học Đường** | ✅ Bottom Nav | ✅ Đã có Desktop Central Nav | Xưởng Toán, Hầm, Rương — xem §2.8.3 |
...
| ⚔️ **Trường Thi** | 🏅 Trường Thi Xếp Hạng (Ranked) <br> 🐲 Khoa Thi (Boss Raid) <br> 🛡️ Vực Sinh Tồn (Survival) | Đỉnh Ngữ Pháp, Tháp Từ Vựng... <br> Từng con Boss cụ thể. <br> Từng mốc Tầng sinh tồn (Tầng 1, Tầng 2). |
...
### 2.8.4 Cấp 3 — Page lá
Như định nghĩa trong bảng trên, Page Cấp 3 là các điểm chạm sâu nhất (ví dụ: một Xưởng Toán cụ thể, một môn Boss, một item cụ thể trong shop). Mỗi điểm này đều có `id` riêng và có thể được ghi nhận dấu vết khám phá.
...
**Ví dụ minh họa** (theo đúng kịch bản user đặt ra): Thuý Nga vào **Học Đường** (Cấp 1) lúc 14:00 hôm qua → khám phá **Xưởng Toán Ngữ Pháp** (Cấp 2, loại `mat_that`) → khám phá 3 Page lá Cấp 3 (Verb Tense, Passive Voice, Relative Clause). 19:00 cùng ngày quay lại Xưởng Toán Ngữ Pháp, khám phá thêm 2 Page con mới.
...
Áp dụng cho toàn bộ các Page Cấp 2 (Xưởng Toán, Hầm, Khu Vực):
...
| :--- | :---: | :---: | :---: | :--- |
| 🌱 **Tân Đệ Tử** | `🌱` | **Level 1 - 4** | 0 | Mới nhập môn học văn học viện, làm quen với các khái niệm căn bản. |
...
| 👑 **Tông Sư** | `👑` | **Level 80+** | 632.000 | Đỉnh phong học văn, danh hiệu cao nhất chỉ dành cho rất ít người xuất chúng. |
...
2.  **Định nghĩa Hàm tiện ích:**
    ...
    export const STUDENT_RANKS: StudentRank[] = [
      ...
      { id: 'tong-su', name: 'Tông Sư', icon: '👑', minLevel: 80, description: 'Đỉnh phong học văn...' }
    ];

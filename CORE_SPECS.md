...
*   **Cơ Chế "Thú Về Chuồng" (Pet Stable & Overlay)**:
    ...
    *   **Các thời điểm heo xuất hiện** (dưới dạng **overlay đè lên layout hiện tại**, nền phía sau làm mờ nhẹ để tập trung vào heo):
        ...
        2.  *Gác Cổng lúc đăng xuất (Logout Gate — "Rời Học Viện"):* Khi thiếu hiệp bấm **Rời Học Viện** (Đăng xuất), Heo xuất hiện mang theo một trang Cẩm Nang khác để dặn dò trước khi rời giang hồ. Để tránh giữ chân cưỡng ép (dark pattern), Thiếu Hiệp hoặc Chủ nhiệm có thể bấm nút "Rời học viện ngay" để hoàn tất đăng xuất ngay lập tức mà không bắt buộc phải thực hiện thọt lét/tương tác thú cưng.
...
*   🏛️ **Chính Điện:** Trung tâm quyền lực và phân quyền. Quản lý tài khoản thiếu hiệp, thăng cấp/hạ cấp vai trò. Đây là nơi quản lý học sinh ở quy mô toàn viện (không chia theo môn phái).
...
3.  **Vị trí hiển thị trên giao diện (UI Integration spots):**
    ...
    *   *Bảng Chủ Nhiệm (Hiệu Trưởng):* Hiển thị danh hiệu hiện tại bên cạnh thông tin tiến độ học tập của thiếu hiệp.
...
| :--- | :--- | :--- |
| 🌱 **Thiếu Hiệp** | Trang Thân Phận | Hạng của bản thân trong Lớp Chủ Nhiệm / Lớp — theo Phút Tu Luyện, Điểm kiếm trong kỳ, Chuỗi ngày, Đẳng cấp môn phái. Chỉ thấy tên/avatar các bạn cùng nhóm; không lộ dữ liệu nhóm khác. |
